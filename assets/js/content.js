/* ============================================================================
   CONTENT.JS — all the words on the site.

   Edit these through tools/editor.html → the Text tab. Hand-editing is fine
   too; keep the quotes and commas intact.

   How it works: elements in the HTML carry data-text="someKey". On load the
   site replaces their contents with the matching value below. The text in the
   HTML files is only a fallback for if this file fails to load, so once you
   start editing here, this file is the source of truth.

   Keys ending in "Body" accept multiple paragraphs — separate them with a
   blank line. Keys ending in "Title" accept line breaks — press Enter where
   you want the line to split.
============================================================================ */
...
window.TEXT = {
  ...
  homeFact1Label: "Based",      homeFact1Value: "Add your city here",
  homeFact2Label: "Travel",     homeFact2Value: "Anywhere there's a stage",
  homeFact3Label: "Turnaround", homeFact3Value: "Same-night selects, full gallery in 72 hours",
  homeFact4Label: "Covers",     homeFact4Value: "Festivals, clubs, tours, press, portraits, weddings, food",
  homeFact5Label: "Clients",    homeFact5Value: "Add promoters, venues and publications here",
  ...
  aboutFact1Label: "Gear",      aboutFact1Value: "List your bodies and fast primes here",
  aboutFact2Label: "Delivery",  aboutFact2Value: "Same-night selects, full gallery in 72 hours",
  aboutFact3Label: "Licensing", aboutFact3Value: "Editorial and commercial, quoted per use",
  aboutFact4Label: "Insured",   aboutFact4Value: "Public liability — add your details",
  ...
  contactFact1Label: "Phone",    contactFact1Value: "Add a number, or delete this row",
  contactFact2Label: "Response", contactFact2Value: "Within 24 hours, usually sooner"
};
